<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchAndViewItemsSummary.aspx.cs" Inherits="StockManagementSystemWebApp.UI.SearchAndViewItemsSummary" %>
            ...
            <div class="f-center">
                ...
                <div class="head-info">
                    <form id="form1" runat="server">
                        <br />
                        <table class="table" style="width: 59%; top: 5px; left: 119px;" align="center">
                            <tr>
                            ...
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label3" runat="server" Text="Category:" Font-Names="Calisto MT" Font-Size="X-Large"></asp:Label>
                                </td>
                                <td>
                        ...
                        <asp:GridView ID="itemGridView" runat="server" AutoGenerateColumns="False" CssClass="GridViewDesign" CellPadding="3" Height="16px" Width="813px" EnableTheming="True" Font-Names="Calisto MT" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Font-Size="X-Large" GridLines="None" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Available Quantity">
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%#Eval("AvailableQuantity")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Reorder Level">
                                    <ItemTemplate>
                                        <asp:Label ID="Label5" runat="server" Text='<%#Eval("ReorderLevel")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
