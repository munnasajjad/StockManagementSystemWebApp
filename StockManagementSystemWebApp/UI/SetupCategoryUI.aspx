<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupCategoryUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.SetupCategoryUI" %>
                ...
                <div class="span9">
                    ...
                    <nav id="nav" role="navigation">
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="active"><a href="SetupCategoryUI.aspx" title="">Category Setup</a></li>
            ...
            <div class="f-center">
                ...
                <div class="head-info">
                    <form id="form1" runat="server">
                        ...
                        &nbsp;<asp:TextBox ID="setupCategoryTextBox" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="251px"></asp:TextBox><br />
                        <asp:Label ID="messageLabel" runat="server" Font-Names="Calisto MT" Font-Size="Large" ForeColor="Red"></asp:Label>
                        <br />
                        <br />
                        <asp:Button ID="setupCategoryButton" runat="server" Text="Save" BackColor="White" BorderColor="#00CCFF" BorderStyle="Ridge" Font-Names="Calisto MT" Font-Size="X-Large" ForeColor="#660033" Font-Bold="True" Height="47px" Width="136px" OnClick="setupCategoryButton_OnClick" />
                        <br />
                        <br />
                        <asp:GridView ID="categoryGridView" runat="server" AutoGenerateColumns="False" CssClass="GridViewDesign" CellPadding="3" Height="16px" Width="800px" EnableTheming="True" Font-Names="Calisto MT" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Font-Size="X-Large" GridLines="None" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="updateCategoryLinkButton" runat="server" OnClick="updateCategoryLinkButton_OnClick">Update</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
