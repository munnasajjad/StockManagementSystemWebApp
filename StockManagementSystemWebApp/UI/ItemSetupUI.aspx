                ...
                <div class="span9">
                    ...
                    <nav id="nav" role="navigation">
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="active"><a href="ItemSetupUI.aspx" title="">Item Setup</a></li>
                        ...
                        <table class="table" style="width: 61%; top: 4px; left: 68px;" align="center">
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label1" runat="server" Text="Category:" Font-Names="Calisto MT" Font-Size="X-Large"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="categoryDropdownList" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="269px"></asp:DropDownList>

                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label3" runat="server" Text="Company:" Font-Names="Calisto MT" Font-Size="X-Large"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="companyDropdownList" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="269px"></asp:DropDownList>

                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label2" runat="server" Text="Item name: " Font-Names="Calisto MT" Font-Size="X-Large"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="itemNameTextBox" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="243px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label4" runat="server" Text="Reorder level: " Font-Names="Calisto MT" Font-Size="X-Large"></asp:Label>
                                </td>
                                <td>
