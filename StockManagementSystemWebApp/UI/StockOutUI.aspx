                ...
                <div class="span9">
                    ...
                    <nav id="nav" role="navigation">
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="active"><a href="StockOutUI.aspx" title="">Stock Out</a></li>
                    ...
                    <form id="form1" runat="server">
                        ...
                        <table class="table" style="width: 61%; top: 4px; left: 68px;" align="center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="reorderLevelTextBox" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style1">
                                ...
                                <td>
                                    <asp:TextBox ID="availableQuantityTextBox" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style1">
                                    <asp:Label ID="Label5" runat="server" Text="Stock out quantity: " Font-Names="Calisto MT" Font-Size="X-Large"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="stockOutTextBox" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="248px"></asp:TextBox>
                                <%--    <asp:RegularExpressionValidator ID = "validStockOut" runat="server" Display="Dynamic" ControlToValidate="stockOutTextBox" ErrorMessage="Invalid stock out quantity (numbers only)!" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>--%>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    <center><asp:Button ID="addButton" runat="server" Text="Add" BackColor="#009999" BorderColor="#333300" BorderStyle="Groove" Font-Names="Footlight MT Light" Font-Size="X-Large" ForeColor="White" Font-Bold="True" Height="55px" Width="115px" BorderWidth="2px" OnClick="addButton_Click"/></center>
                                </td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <asp:GridView ID="stockOutGridView" runat="server" AutoGenerateColumns="False" CssClass="GridViewDesign" CellPadding="3" Height="16px" Width="650px" EnableTheming="True" Font-Names="Calisto MT" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Font-Size="X-Large" GridLines="None" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Category">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="companyIdHiddenField" runat="server"  Value='<%#Eval("CompanyId") %>'/>
                                ...
                                <asp:TemplateField HeaderText="Quantity">
                                    <ItemTemplate>
                                        <asp:Label ID="Label4" runat="server" Text='<%#Eval("StockOutQuantity")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <asp:Button ID="sellButton" runat="server" Text="Sell" BackColor="#669999" Font-Names="Candara" Font-Size="X-Large" ForeColor="#FF0066" Height="49px" Width="144px" OnClick="sellButton_Click" />
                        <asp:Button ID="damageButton" runat="server" Text="Damage" BackColor="#669999" Font-Names="Candara" Font-Size="X-Large" ForeColor="#FF0066" Height="49px" Width="147px" OnClick="damageButton_Click" />
                        <asp:Button ID="lostButton" runat="server" Text="Lost" BackColor="#669999" Font-Names="Candara" Font-Size="X-Large" ForeColor="#FF0066" Height="49px" Width="129px" OnClick="lostButton_Click" />
                    </form>
