<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupCompanyUI.aspx.cs" Inherits="StockManagementSystemWebApp.UI.SetupCompanyUI" %>
            ...
            <div class="f-center">
                ...
                <div class="head-info">
                    <form id="form1" runat="server">
                        ...
                        &nbsp;<asp:TextBox ID="companyTextBox" runat="server" Font-Names="Calisto MT" Font-Size="X-Large" Width="251px"></asp:TextBox><br />
                        <asp:Label ID="messageLabel" runat="server" Font-Names="Calisto MT" Font-Size="Large" ForeColor="Red"></asp:Label>
                        <br />
                        <br />
                        <asp:Button ID="setupCompanyButton" runat="server" Text="Save" BackColor="White" BorderColor="#00CCFF" BorderStyle="Ridge" Font-Names="Calisto MT" Font-Size="X-Large" ForeColor="#660033" Font-Bold="True" Height="47px" Width="136px" OnClick="setupCompanyButton_OnClick" />
                        <br />
                        <br />
                        <asp:GridView ID="companyGridView" runat="server" AutoGenerateColumns="False" CssClass="GridViewDesign" CellPadding="3" Height="16px" Width="800px" EnableTheming="True" Font-Names="Calisto MT" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Font-Size="X-Large" GridLines="None" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="updateCompanyLinkButton" runat="server" OnClick="updateCompanyLinkButton_OnClick">Update</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
